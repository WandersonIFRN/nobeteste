...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference("Contum.count") do
      post conta_url, params: { contum: { cpf: @contum.cpf, nome: @contum.nome, saldo: @contum.saldo, senha: @contum.senha, tipo: @contum.tipo } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { cpf: @contum.cpf, nome: @contum.nome, saldo: @contum.saldo, senha: @contum.senha, tipo: @contum.tipo } }
