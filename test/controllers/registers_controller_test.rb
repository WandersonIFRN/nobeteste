...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference("Register.count") do
      post registers_url, params: { register: { descricao: @register.descricao, saldo: @register.saldo, tipo: @register.tipo, valor: @register.valor } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { descricao: @register.descricao, saldo: @register.saldo, tipo: @register.tipo, valor: @register.valor } }
